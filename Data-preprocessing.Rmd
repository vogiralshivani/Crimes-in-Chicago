...
ggplot(data_2019, aes(y = primary_type_x)) +
  geom_bar() + ylab("Crime Type") + ggtitle("Frequencies of different crimes in Chicago")
...
ggplot(locations, aes(y = Freq, x = locations))+
  geom_point()+
  theme(axis.text.x = element_text(angle = 90)) + ylab('Frequency') + xlab("Location") + ggtitle("Frequencies of crimes at different locations in Chicago")
```
